...
- **`OData V2 - UI` 과거 버전 웹 화면용:** 구형 SAPUI5 아키텍처나 예전 버전의 Fiori 표준 화면과의 하위 호환성을 맞추기 위해 제공하는 구형 규격입니다.
- **`OData V4 - Web API` 순수 데이터 연동용(화면X):** 타 시스템이나 모바일 앱, 외부 자바스크립트단에 화면 버튼 없이 순수 데이터(JSON)만 REST API로 쏴줄 때 씁니다.
- **`OData V2 - Web API` 과거 버전 데이터 연동용:** 외부 레거시 시스템이 구형 OData V2 규격 통신만 지원할 때 어쩔 수 없이 매핑해 주는 연동용 규격입니다.
...
<div style="display: flex; gap: 10px;">
  <div style="flex: 75;">
    <img src="../_images/20260808/2026-08-08-100000-rap-walkthrough_image18.png" alt="관련 이미지" style="width: 100%; height: auto;">
  </div>
  <div style="flex: 25;">
    <img src="../_images/20260808/2026-08-08-100000-rap-walkthrough_image19.png" alt="관련 이미지" style="width: 100%; height: auto;">
  </div>
</div>
