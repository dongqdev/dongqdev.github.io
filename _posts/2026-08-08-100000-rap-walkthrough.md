...
```
b. ABAP 클래스 생성(NEW > ABAP CLASS)한 후, interfaces ADD > IF_OO_ADT_CLASSRUN<br>* Active 후, F9(실행)
```javascript
...
...
```
d. ZC_TWBS_TASK2 인터페이스 뷰에 콤보박스 설정
```javascript
@Consumption.valueHelpDefinition: [{
  entity: { name: 'ZC_TWBS_CATEGORY', element: 'CategoryName' },
...
<details>
<summary> <b>표준 도메인 사용하기(눌러서 열기)</b></summary>
...
<details>
<summary> <b>달력 만들기(눌러서 열기)</b></summary>
